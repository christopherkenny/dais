...
- **Remote** (`--remote`): Local HTTP API, browser remote at `/remote`, and `dais remote ...` commands for scripts, Stream Decks, phone/tablet controls, and other external adapters.
